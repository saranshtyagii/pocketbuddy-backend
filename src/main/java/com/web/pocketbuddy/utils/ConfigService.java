...
import com.web.pocketbuddy.entity.dao.ConfigMasterDao;
...
public class ConfigService {
	...
	private final ConfigMasterDao configMasterDoa;
	...
	@Autowired
	public ConfigService(ConfigMasterDao configMasterDoa, UserService userService,
	...
	private void validateResources() {
		try {
			...
			groupExpenseService.deleteExpenseFromDb(savedGroupExpense.getExpenseId(), ConfigService.getConfig().getApiKey());
			groupDetailService.deleteGroupFromDb(savedGroup.getGroupId(), ConfigService.getConfig().getApiKey());
